...
var remocon =function(){
    ...
    top_ButtonImg  = frame.addSprite(container,"top_ButtonImg",{width: 18.5, height:                                          27,x:5.5,y:76.8});
    btm_ButtonImg  = frame.addSprite(container,"btm_ButtonImg",{width: 16.5, height:                                          27,x:37.5,y:76.8});
